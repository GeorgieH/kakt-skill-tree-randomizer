...
{
    private static IEnumerable<Type>? DefenderSkills;

    public static IEnumerable<Type> GetDefenderSkills()
    {
        DefenderSkills ??= new HashSet<Type>
        {
            typeof(BatteringRam),
